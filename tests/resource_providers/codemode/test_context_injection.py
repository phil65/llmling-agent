...
class TestContextInjection:
    """Test context injection for tools in code execution environment."""

    @pytest.mark.asyncio
    async def test_direct_context_call_fails(self):
        ...
        generator = await code_provider._get_toolset_generator()
    ...
    @pytest.mark.asyncio
    async def test_simple_tool_works(self):
    ...
    @pytest.mark.asyncio
    async def test_context_signature_hiding(self):
        ...
        signature_match = re.search(
            r"async def tool_with_run_context\([^)]*\)", description
        )
    ...
    @pytest.mark.asyncio
    async def test_agent_context_signature_hiding(self):
    ...
    @pytest.mark.asyncio
    async def test_dual_context_signature_hiding(self):
