        ...
        try:
            ...
            content_blocks = [
                ContentToolCallContent(
                    content=TextContentBlock(text=f"```diff\n{diff_content}\n```")
                )
            ]
    ...
    async def execute_command(
        ...
        *,
        ...
        try:
            ...
            content_blocks = [
                ContentToolCallContent(
                    content=TextContentBlock(text=f"```markdown\n{markdown_content}\n```")
                )
            ]
        ...
        *,
        ...
        try:
            ...
            await session.notifications.tool_call_progress(
                tool_call_id=tool_call_id,
                status="completed",
                title=f"Repository {display_path} fetched and staged ({staged_count} total parts)",  # noqa: E501
                content=content_blocks,
            )
