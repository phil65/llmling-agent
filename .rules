...
├── agentpool_commands/     # Slash command system
├── agentpool_config/       # Configuration schemas and loaders
├── agentpool_docs/         # Documentation generation + examples
├── agentpool_prompts/      # Prompt hub integrations
├── agentpool_resources/    # Resource management
├── agentpool_server/       # Web server and API
├── agentpool_storage/      # Storage providers (SQL, file, memory)
└── agentpool_toolsets/     # Tool collections (Composio, MCP, etc.)
```
